...
def haakjes(string):
    """
    function haakjes(string), fuction that looks if the "()[]<>" are in good order of close and open
    -----------------------------------------------
    PARAMETERS:
    string : string 
    ------------------------------------------------
    ...
    False : bool (if order isn't correct)
    True  : bool (if order  is correct  )
    ---------------------------------------------------
    EXAMPLE:
    ...
    for i in string:
        if i in open_brackets:
            stack.push(i)
        elif i in closed_brackets and (open_brackets.index(stack.pop()) == closed_brackets.index(i)):
            continue
        else:
            return False
